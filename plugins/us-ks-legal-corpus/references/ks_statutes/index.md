# Kansas Statutes — Comprehensive Chapter Index

## Overview

The **Kansas Statutes** is the codification of all permanent general and local laws enacted by the state legislature, organized by title/chapter/subchapter. References use the convention **Kan. Stat. § X.X** for citations.
