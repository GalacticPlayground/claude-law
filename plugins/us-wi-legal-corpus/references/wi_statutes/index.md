# Wisconsin Statutes — Comprehensive Chapter Index

## Overview

The **Wisconsin Statutes** is the codification of all permanent general and local laws enacted by the state legislature, organized by title/chapter/subchapter. References use the convention **Wis. Stat. § X.X** for citations.

## Property/Family Law Classification: all-marital property / equitable distribution (marital property agreement regime)
...
- **Family-specific property**: all-marital property / equitable distribution (marital property agreement regime)
