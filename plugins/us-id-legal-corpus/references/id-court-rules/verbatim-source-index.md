# ID Court Rules — Canonical Index (with verbatim where reachable)
...
This corpus's CI workflow runs `python3 scripts/pull_id_court_rules.py` quarterly. That script's contract is to:

1. Fetch the canonical rules index at <https://isc.idaho.gov/rules-of-practice-and-procedure>
...
4. Write one MD file per rule family under `references/id-court-rules/verbatim/`
