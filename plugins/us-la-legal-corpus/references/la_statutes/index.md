# Louisiana Revised Statutes — Comprehensive Chapter Index

## Overview

The **Louisiana Revised Statutes** is the codification of all permanent general and local laws enacted by the state legislature, organized by title/chapter/subchapter. References use the convention **La. Rev. Stat. § X.X** for citations.

## Property/Family Law Classification: community property (Civil Code based)
...
- **Family-specific property**: community property (Civil Code based)
