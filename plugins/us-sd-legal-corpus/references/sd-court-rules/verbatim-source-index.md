# SD Court Rules — Canonical Index (with verbatim where reachable)

**Source:** <https://ujs.sd.gov/Court_Rules/default.aspx>
...
This corpus's CI workflow runs `python3 scripts/pull_sd_court_rules.py` quarterly. That script's contract is to:

1. Fetch the canonical rules index at <https://ujs.sd.gov/Court_Rules/default.aspx>
...
4. Write one MD file per rule family under `references/sd-court-rules/verbatim/`
