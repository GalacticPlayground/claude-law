# TX Court Rules — Canonical Index (with verbatim where reachable)
...
This corpus's CI workflow runs `python3 scripts/pull_tx_court_rules.py` quarterly. That script's contract is to:

1. Fetch the canonical rules index at <https://www.txcourts.gov/rules-forms/rules-of-court/>
...
4. Write one MD file per rule family under `references/tx-court-rules/verbatim/`
