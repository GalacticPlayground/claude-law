# Texas Statutes — Comprehensive Chapter Index

## Overview

The **Texas Statutes** is the codification of all permanent general and local laws enacted by the state legislature, organized by title/chapter/subchapter. References use the convention **Tex. § X.X** for citations.
