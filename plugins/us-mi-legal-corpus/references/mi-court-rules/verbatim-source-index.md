# MI Court Rules — Canonical Index (with verbatim where reachable)
...
This corpus's CI workflow runs `python3 scripts/pull_mi_court_rules.py` quarterly. That script's contract is to:

1. Fetch the canonical rules index at <https://courts.michigan.gov/courts/supremecourt/clerks/rules-court-orders>
...
4. Write one MD file per rule family under `references/mi-court-rules/verbatim/`
