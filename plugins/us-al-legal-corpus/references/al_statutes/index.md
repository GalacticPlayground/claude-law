# Code of Alabama — Comprehensive Chapter Index

## Overview

The **Code of Alabama** is the codification of all permanent general and local laws enacted by the state legislature, organized by title/chapter/subchapter. References use the convention **Ala. Code § X.X** for citations.

## Property/Family Law Classification: community property + Equity adoption
...
- **Family-specific property**: community property + Equity adoption
