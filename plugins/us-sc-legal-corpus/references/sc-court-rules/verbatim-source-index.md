# SC Court Rules — Canonical Index (with verbatim where reachable)
...
This corpus's CI workflow runs `python3 scripts/pull_sc_court_rules.py` quarterly. That script's contract is to:

1. Fetch the canonical rules index at <https://www.sccourts.org/supreme-court/displaystatute.php?statute=rule>
...
4. Write one MD file per rule family under `references/sc-court-rules/verbatim/`
