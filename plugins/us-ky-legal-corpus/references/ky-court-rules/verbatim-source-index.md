# KY Court Rules — Canonical Index (with verbatim where reachable)
...
This corpus's CI workflow runs `python3 scripts/pull_ky_court_rules.py` quarterly. That script's contract is to:

1. Fetch the canonical rules index at <https://kycourts.net/Courts/Supreme-Court/Supreme-Court-Rules>
...
4. Write one MD file per rule family under `references/ky-court-rules/verbatim/`
