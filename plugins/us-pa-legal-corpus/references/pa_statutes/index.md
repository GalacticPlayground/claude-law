# Pennsylvania Consolidated Statutes — Comprehensive Chapter Index

## Overview

The **Pennsylvania Consolidated Statutes** is the codification of all permanent general and local laws enacted by the state legislature, organized by title/chapter/subchapter. References use the convention **Pa.C.S. § X.X** for citations.

## Property/Family Law Classification: all-marital property / equitable distribution
...
- **Family-specific property**: all-marital property / equitable distribution
