# North Dakota Century Code — Comprehensive Chapter Index

## Overview

The **North Dakota Century Code** is the codification of all permanent general and local laws enacted by the state legislature, organized by title/chapter/subchapter. References use the convention **NDCC § X.X** for citations.

## Property/Family Law Classification: community property (ND Constitution)
...
- **Family-specific property**: community property (ND Constitution)
