# MS Court Rules — Canonical Index (with verbatim where reachable)
...
This corpus's CI workflow runs `python3 scripts/pull_ms_court_rules.py` quarterly. That script's contract is to:

1. Fetch the canonical rules index at <https://courts.ms.gov/rules/rules.php>
...
4. Write one MD file per rule family under `references/ms-court-rules/verbatim/`
