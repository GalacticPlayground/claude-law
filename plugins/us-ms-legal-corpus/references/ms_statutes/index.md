# Mississippi Code — Comprehensive Chapter Index

## Overview

The **Mississippi Code** is the codification of all permanent general and local laws enacted by the state legislature, organized by title/chapter/subchapter. References use the convention **Miss. Code § X.X** for citations.

## Property/Family Law Classification: all-marital property (head & master)
...
- **Family-specific property**: all-marital property (head & master)
