# Nevada Revised Statutes — Comprehensive Chapter Index

## Overview

The **Nevada Revised Statutes** is the codification of all permanent general and local laws enacted by the state legislature, organized by title/chapter/subchapter. References use the convention **NRS § X.X** for citations.

## Property/Family Law Classification: community property
...
- **Family-specific property**: community property
