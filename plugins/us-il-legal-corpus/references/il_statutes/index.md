# Illinois Compiled Statutes — Comprehensive Chapter Index

## Overview

The **Illinois Compiled Statutes** is the codification of all permanent general and local laws enacted by the state legislature, organized by title/chapter/subchapter. References use the convention **ILCS § X.X** for citations.
