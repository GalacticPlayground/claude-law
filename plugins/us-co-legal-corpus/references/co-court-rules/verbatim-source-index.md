# CO Court Rules — Canonical Index (with verbatim where reachable)

**Source:** <https://www.courts.state.co.us/Supreme_Court/Index.cfm>
...
This corpus's CI workflow runs `python3 scripts/pull_co_court_rules.py` quarterly. That script's contract is to:

1. Fetch the canonical rules index at <https://www.courts.state.co.us/Supreme_Court/Index.cfm>
...
4. Write one MD file per rule family under `references/co-court-rules/verbatim/`
