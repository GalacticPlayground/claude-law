# VA Court Rules — Canonical Index (with verbatim where reachable)
...
This corpus's CI workflow runs `python3 scripts/pull_va_court_rules.py` quarterly. That script's contract is to:

1. Fetch the canonical rules index at <https://www.vacourts.gov/courts/scc/rules_of_court.pdf>
...
4. Write one MD file per rule family under `references/va-court-rules/verbatim/`
