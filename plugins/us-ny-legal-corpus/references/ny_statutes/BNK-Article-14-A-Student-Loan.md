# Banking Law — Student Loan Servicers

> **Source:** https://legislation.nysenate.gov/api/3/laws/BNK?full=true
> **Fetched:** 2026-06-04
...
of this article, the student loan servicer shall submit to the
superintendent the name, address, and occupation of each new officer,
director, partner or member, and provide such other information as the
...
1. In addition to such powers as may
...
1. If a student loan servicer regularly
...
promulgated hereunder a sum not to exceed the greater of (i) two
thousand dollars or where such violation is willful ten thousand dollars
for each offense; (ii) a multiple of two times the aggregate damages
attributable to the violation; or (iii) a multiple of two times the
...
article, and the application of such provision to persons or
...
1. Student loan servicers shall
