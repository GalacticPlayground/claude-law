...
skill in the `us-ca-legal-corpus` plugin. The prompts are
...
- `us-or-legal-corpus/evals/` — the parallel OR evals (same framework)
- `us-wa-legal-corpus/evals/` — the parallel WA evals
