...
## Skills index — Federal consumer credit-report rights (`us-federal-debt-corpus`, 5 skills)
...
## Skills index — Federal immigration self-help (`us-federal-immigration-corpus`, 11 skills)
...
## Skills index — Washington (`us-wa-legal-corpus`, 32 skills)
...
## Skills index — Oregon (`us-or-legal-corpus`, 21 skills)
...
## Skills index — California (`us-ca-legal-corpus`, 21 skills)
...
## Skills index — Colorado (`us-co-legal-corpus`, 22 skills)
...
## Skills index — New York (`us-ny-legal-corpus`, 35 skills)
...
## Skills index — Tennessee (`us-tn-legal-corpus`, 31 skills)
...
## Skills index — Michigan (`us-mi-legal-corpus`, 29 skills)
...
## Skills index — Arizona (`us-az-legal-corpus`, 28 skills)
...
- **`federal-debt-laws/`** *(symlink)* — points into `us-federal-debt-corpus/references/federal-debt-laws/`. **20 sources**: FDCPA, FCRA, TILA, ECOA, EFTA, CCPA-Garnishment (15 U.S.C. §§ 1671-1677), **RESPA (12 U.S.C. §§ 2601-2617), SCRA (50 U.S.C. ch 50), FHA (42 U.S.C. ch 45 subch I), FTC Telemarketing Sales Rule (16 C.F.R. Part 310)**, plus CFPB Reg B / E / F / M / N / P / V / X / Z / DD from `uscode.house.gov` USLM XML and the eCFR Versioner API.
- **`federal-bankruptcy/`** *(symlink)* — points into `us-federal-debt-corpus/references/federal-bankruptcy/`. **8 chapters** of Title 11 U.S.C.: Chapter 1 (General), 3 (Case Administration), 5 (Creditors / Debtor / Estate), 7 (Liquidation), 11 (Reorganization), 12 (Family Farmer / Fisherman), 13 (Adjustment of Debts), 15 (Cross-Border).
- **`ucc-model/`** *(symlink)* — points into `us-federal-debt-corpus/references/ucc-model/`. Model UCC Articles 1, 2, 3, 9 (Cornell LII).
...
- **`federal-debt-laws/`** *(symlink)* — points into `us-federal-debt-corpus/references/federal-debt-laws/`.
- **`federal-bankruptcy/`** *(symlink)* — points into `us-federal-debt-corpus/references/federal-bankruptcy/`.
- **`ucc-model/`** *(symlink)* — points into `us-federal-debt-corpus/references/ucc-model/`.
...
## Reference corpora — Immigration (`us-federal-immigration-corpus/references/`)

Federal, venue-independent corpus: **rules snapshotted verbatim, case law indexed for on-demand lookup**. No `<state>-law-references` skill host — the corpora live directly under `plugins/us-federal-immigration-corpus/references/`, and **each dir's `README.md` carries the detail** (scope, pull mechanics, access posture).
...
python3 plugins/us-wa-legal-corpus/scripts/format-check.py <file>   # GR 14 compliance
python3 plugins/us-wa-legal-corpus/scripts/case-calendar.py ...     # CR 6 deadline arithmetic
python3 plugins/us-or-legal-corpus/scripts/format-check.py <file>   # UTCR 2.010 compliance
python3 plugins/us-or-legal-corpus/scripts/case-calendar.py ...     # ORCP 10 deadline arithmetic with ORS 187 holidays

# Refresh reference corpora — California
python3 scripts/pull_ca_court_rules.py --workers 8 \
  --out plugins/us-ca-legal-corpus/skills/ca-law-references/references/court-rules
python3 scripts/pull_ca_statutes.py --workers 8 \
  --out plugins/us-ca-legal-corpus/skills/ca-law-references/references/ca-statutes-debt

# California scripts
python3 plugins/us-ca-legal-corpus/scripts/format-check.py <file>   # CRC 2.100-2.119 compliance
python3 plugins/us-ca-legal-corpus/scripts/case-calendar.py ...     # CCP § 12 deadline arithmetic with Govt. Code § 6700 holidays

# Colorado scripts
python3 plugins/us-co-legal-corpus/scripts/format-check.py <file>   # C.R.C.P. 10 + CJD 11-01 compliance
python3 plugins/us-co-legal-corpus/scripts/case-calendar.py ...     # C.R.C.P. 6 deadline arithmetic with C.R.S. § 24-11-101 holidays
python3 plugins/us-co-legal-corpus/scripts/case-calendar.py --rules # List Colorado named deadline rules
...
# New York scripts
python3 plugins/us-ny-legal-corpus/scripts/format-check.py <file>   # 22 NYCRR § 202.5 + § 202.5-b compliance
python3 plugins/us-ny-legal-corpus/scripts/case-calendar.py ...     # CPLR 2103 deadline arithmetic with NY Gen. Constr. Law § 24 holidays
python3 plugins/us-ny-legal-corpus/scripts/case-calendar.py --rules # List New York named deadline rules

# Refresh reference corpora — Tennessee
python3 scripts/pull_tn_court_rules.py --workers 2 \
  --out plugins/us-tn-legal-corpus/skills/tn-law-references/references/court-rules
# Without Justia reachable, this writes well-formed pointer stubs:
python3 scripts/pull_tn_statutes.py --workers 4 \
  --out plugins/us-tn-legal-corpus/skills/tn-law-references/references/tn-statutes-debt
# Or force stubs explicitly:
python3 scripts/pull_tn_statutes.py --workers 4 --stubs-only

# Tennessee scripts
python3 plugins/us-tn-legal-corpus/scripts/format-check.py <file>   # Tenn. R. Civ. P. 10/11 + local-rule common-practice check
python3 plugins/us-tn-legal-corpus/scripts/case-calendar.py ...     # Tenn. R. Civ. P. 6.01/6.05 deadline arithmetic with Tenn. Code Ann. § 15-1-101 holidays (incl. Good Friday + Columbus Day)
python3 plugins/us-tn-legal-corpus/scripts/case-calendar.py --rules # List Tennessee named deadline rules
...
python3 scripts/pull_michigan_statutes.py --workers 4 \
  --out plugins/us-mi-legal-corpus/skills/mi-law-references/references/mi-statutes-debt
...
python3 scripts/pull_michigan_rules.py --workers 2 \
  --out plugins/us-mi-legal-corpus/skills/mi-law-references/references/court-rules

# Michigan scripts
python3 plugins/us-mi-legal-corpus/scripts/format-check.py <file>   # MCR 1.109 / 2.113 compliance
python3 plugins/us-mi-legal-corpus/scripts/case-calendar.py ...     # MCR 1.108 deadline arithmetic with MCL 435.101 holidays (incl. Lincoln's Birthday + day-after-Thanksgiving)
python3 plugins/us-mi-legal-corpus/scripts/case-calendar.py --rules # List Michigan named deadline rules

# Refresh reference corpora — Arizona
python3 scripts/pull_arizona_statutes.py --workers 4 \
  --out plugins/us-az-legal-corpus/skills/az-law-references/references/az-statutes-debt
...
python3 scripts/pull_arizona_rules.py --workers 2 \
  --out plugins/us-az-legal-corpus/skills/az-law-references/references/court-rules

# Arizona scripts
python3 plugins/us-az-legal-corpus/scripts/format-check.py <file>   # Ariz. R. Civ. P. 10 / 7.1 compliance
python3 plugins/us-az-legal-corpus/scripts/case-calendar.py ...     # Ariz. R. Civ. P. 6 deadline arithmetic with A.R.S. § 1-301 holidays
python3 plugins/us-az-legal-corpus/scripts/case-calendar.py --rules # List Arizona named deadline rules
```
...
1. **Naming**: `us-<state>-legal-corpus` (e.g., `us-ca-legal-corpus`, `us-tx-legal-corpus`).
...
6. **Federal law is shared content in a dedicated plugin**: the FDCPA/FCRA/TILA text, the Bankruptcy Code (Title 11 U.S.C.), and the model UCC live once in `plugins/us-federal-debt-corpus/references/`. Each state plugin's `references/federal-debt-laws/`, `references/federal-bankruptcy/`, and `references/ucc-model/` are **symlinks** into that shared plugin, and each state plugin's `plugin.json` declares `"dependencies": ["us-federal-debt-corpus"]`. The Claude Code marketplace runtime auto-installs the dependency and dereferences symlinks within a marketplace at install time (copying target content into the install cache), so each installed state plugin still has the federal content locally available. When adding a new state plugin, copy this dependency declaration + symlink pattern; do **not** copy the federal-debt-laws or federal-bankruptcy or ucc-model content directly.
...
- The 21-skill pattern derived from `us-wa-legal-corpus` and `us-or-legal-corpus`
...
plugins/us-federal-debt-corpus/  # SHARED federal-law plugin; depended on by every state plugin
...
plugins/us-federal-immigration-corpus/  # SHARED immigration-law plugin: reference corpora + an 11-skill venue-independent self-help layer (v0.3.0)
  ...
  skills/                               # 11-skill venue-independent self-help layer (v0.3.0): immigration-pro-se, eoir-immigration-courts, immigration-deadlines, immigration-fact-check, eoir-removal-defense, eoir-motions-to-reopen-reconsider, bia-appeals, uscis-benefit-requests, immigration-foia, circuit-petition-for-review, consular-visa-refusal
...
plugins/us-wa-legal-corpus/
  .claude-plugin/plugin.json        # plugin manifest (version); declares dependencies: [us-federal-debt-corpus]
...
plugins/us-or-legal-corpus/              # same shape; declares dependencies: [us-federal-debt-corpus]
  ...
  evals/
plugins/us-ca-legal-corpus/              # scaffolded stubs (lint-clean; awaiting substantive content)
  .claude-plugin/plugin.json
  ...
  scripts/format-check.py           # copied from us-or-legal-corpus; TODO-marked for CRC 2.100-2.119 adaptation
  scripts/case-calendar.py          # copied from us-or-legal-corpus; TODO-marked for CCP § 12 / Govt. Code § 6700
  evals/                            # empty drafting/formatting/procedural/subject-matter/integration dirs + stub README
plugins/us-co-legal-corpus/              # 22 skills (21 standard + co-family-law)
...
plugins/us-tn-legal-corpus/              # 31 skills (statewide-format + 4 flagship county venues — Davidson/Shelby/Knox/Hamilton — + General Sessions + county-courts roll-up + split family-court/juvenile-court + 14 standard procedural + 6 subject bundles: consumer-debt + family-law + landlord-tenant + personal-injury + employment + commercial-disputes); declares dependencies: [us-federal-debt-corpus]
...
plugins/us-mi-legal-corpus/              # 29 skills (statewide-format + 2 flagship Circuit Court venues — Wayne/Oakland — + 36th District Court + Circuit-courts roll-up + District-courts roll-up + Family Division + 14 standard procedural + 6 subject bundles: consumer-debt + family-law + landlord-tenant + personal-injury + employment + commercial-disputes); declares dependencies: [us-federal-debt-corpus]
  .claude-plugin/plugin.json
...
plugins/us-az-legal-corpus/              # 28 skills (statewide-format + Maricopa + Pima Superior Court venues + Justice Courts + Superior-courts roll-up + Family Department + 14 standard procedural + 6 subject bundles: consumer-debt + family-law + landlord-tenant + personal-injury + employment + commercial-disputes); declares dependencies: [us-federal-debt-corpus]
  .claude-plugin/plugin.json
...
scripts/
  ...
  pull_federal_debt_laws.py         # uscode.house.gov + ecfr.gov → plugins/us-federal-debt-corpus/references/federal-debt-laws/
  pull_ucc.py                       # law.cornell.edu/ucc → plugins/us-federal-debt-corpus/references/ucc-model/
